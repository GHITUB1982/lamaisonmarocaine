 ...
 */
final class Version20250726003255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_posts ADD author_id INT NOT NULL, DROP author_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_posts ADD author_id_id INT DEFAULT NULL, DROP author_id');
        $this->addSql('ALTER TABLE blog_posts ADD CONSTRAINT FK_78B2F93269CCBE9A FOREIGN KEY (author_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
