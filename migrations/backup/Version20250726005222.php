 ...
 */
final class Version20250726005222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_posts ADD category_id_id INT DEFAULT NULL, CHANGE views_count views_count INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_posts DROP category_id_id, CHANGE views_count views_count INT NOT NULL');
    }
}
