...
class BlogPosts
{
    ...
    private ?string $featuredImage = null;  // Changé pour camelCase

    #[ORM\Column(length: 60, nullable: true)]
    private ?string $metaTitle = null;  // Changé pour camelCase

    #[ORM\Column(length: 20)]
    private string $status = 'draft';

    #[ORM\Column(length: 160, nullable: true)]
    private ?string $metaDescription = null;  // Changé pour camelCase
